...
def RadiomicsRDF(patientID,myStructUID,featuretable):
	...
	with open("./ORAW_UniversalTemplate.yaml", 'r') as data:
		try:
	...
	df_RO = pd.read_csv(os.path.join(os.getcwd(),'RadiomicsOntologyTable.csv'))
	radiomics_key = featuretable.keys()
